  ...
  return (
    ...
    <main className="l-main">
      ...
      <section className="home bd-grid" id="home">
        ...
        <div className="home__social">
          <a href className="home__social-icon"><i className="bx bxl-linkedin" /></a>
          <a href className="home__social-icon"><i className="bx bxl-behance" /></a>
          <a href className="home__social-icon"><i className="bx bxl-github" /></a>
        </div>
      ...
      <section className="contact section" id="contact">
        ...
        <div className="contact__container bd-grid">
          <form action className="contact__form">
            ...
            <input type="button" defaultValue="Enviar" className="contact__button button" />
          </form>
        </div>
      </section>
    </main>
    ...
    <footer className="footer">
      ...
      <div className="footer__social">
        <a href="/#" className="footer__icon"><i className="bx bxl-facebook" /></a>
        <a href="/#" className="footer__icon"><i className="bx bxl-instagram" /></a>
        <a href="/#" className="footer__icon"><i className="bx bxl-twitter" /></a>
      </div>
